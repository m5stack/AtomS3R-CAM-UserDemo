 ...
 * @retval < 0 -> Fail
 */
static int8_t read_sensor_data(uint8_t aux_len, uint8_t acc_len, uint8_t gyr_len, uint8_t *sensor_data,
                               struct bmi2_dev *dev);
 ...
 * @retval < 0 -> Fail
 */
static int8_t parse_data(uint8_t aux_len, uint8_t acc_len, uint8_t gyr_len, struct bmi2_sens_data *data,
                         const uint8_t *sensor_data, struct bmi2_dev *dev);
